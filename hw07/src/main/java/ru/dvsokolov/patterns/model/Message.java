...
public class Message {
    ...
    public Message copy() {
        ...
        var originalObjectForMessage = this.getField13();
        var copyObjectForMessage = (originalObjectForMessage == null) ? originalObjectForMessage : originalObjectForMessage.copy();
